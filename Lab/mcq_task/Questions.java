...
public class Questions {
	...
	public static void capitalsQuestions() {
		...
		//setting string as key and answer(character) as value
		q.setQuestion(s);
		q.setAnswer('A');
		...
		for(Map.Entry<Question, Options> entry: t1.subject.entrySet()){  
	        ...
	        if(key.getChosenAnswer()==key.getAnswer()) {
	        	...
	        	key.setMarksAwarded(1);
	        	marks++;
	        }
	        else {
	        	System.out.println("Wrong Answer\n");
	        }
	        student.setCapitalsMarks(marks);
	        i++;
	    }  
	}

	public static void mathematicsQuestions() {
	...
	public static void printKeyPaper() {
		...
		for(Map.Entry<Question, Options> entry: t1.subject.entrySet()){  
	        ...
	        System.out.println(str1 + key.getAnswer() + str2 + key.getChosenAnswer() +str3 + key.getMarksAwarded());
	    } 
